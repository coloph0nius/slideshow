...
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt5/bin/qmake -o Makefile Slideshow.pro
#############################################################################
...
INCPATH       = -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I. -I. -isystem /usr/include/arm-linux-gnueabihf/qt5 -isystem /usr/include/arm-linux-gnueabihf/qt5/QtWidgets -isystem /usr/include/arm-linux-gnueabihf/qt5/QtGui -isystem /usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: Slideshow.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Slideshow.pro
...
dist: 
	@test -d .tmp/Slideshow1.0.0 || mkdir -p .tmp/Slideshow1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/Slideshow1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/Slideshow1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/Slideshow1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Slideshow1.0.0/ && (cd `dirname .tmp/Slideshow1.0.0` && $(TAR) Slideshow1.0.0.tar Slideshow1.0.0 && $(COMPRESS) Slideshow1.0.0.tar) && $(MOVE) `dirname .tmp/Slideshow1.0.0`/Slideshow1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Slideshow1.0.0
...
moc_mainwindow.cpp: mainwindow.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/Qt/Slideshow -I/home/pi/Qt/Slideshow -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include mainwindow.h -o moc_mainwindow.cpp
